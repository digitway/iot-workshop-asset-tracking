...
const TSI_FQDN = 'd92caea8-4c90-461e-9514-02f00f637575.env.timeseries.azure.com'; // You can find this in the overview of your Time Series Insights resource in the Azure portal
const AZURE_MAPS_SUBSCRIPTION_KEY = 'gTtDGdhqTWMNgg1L1gBaM5Wbsd9Hc-G1j2nkLUbRHb4';            // Your Azure Maps subscription key. Get your key in the "Authentication" section of your Azure Maps service in the Azure Portal
const TIME_SERIES_ID = 'iothub-connection-device-id';                         // The ID of the device (and hence associated time series) you want to display in this page
